...
export default function ResellerLoyaltyPage() {
    ...
    useEffect(() => {
        async function loadData() {
            if (user) {
                ...
                setLoyaltyConfig(config.loyalty);
                setLoading(false);
            }
        }
        loadData();
    ...
    const loyaltyTiers = loyaltyConfig.resellerLoyaltyTiers || loyaltyConfig.tiers;
    ...
    return (
        <div className="space-y-6">
            <header className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight">Chương trình Đối tác Thân thiết</h1>
            ...
            <Separator />
             ...
             <div>
                <h2 className="text-2xl font-semibold mb-4">Quyền lợi các hạng đối tác</h2>
